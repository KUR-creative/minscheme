...
namespace Catch {
    ...
    IResultCapture& getResultCapture() {
        if( IResultCapture* capture = getCurrentContext().getResultCapture() )
            ...
            throw std::logic_error( "No make_result capture instance" );
    }
...
#define TWOBLUECUBES_CATCH_DEBUGGER_HPP_INCLUDED
    ...
    namespace Catch{
        ...
        bool isDebuggerActive(){
            ...
            // reason, we get a predictable make_result.
...
namespace Catch {
    ...
    public: // StreamingReporterBase
        ...
        virtual bool assertionEnded( AssertionStats const& assertionStats ) CATCH_OVERRIDE {
            ...
            // Drop out if make_result was successful but we're not printing them.
            ...
            // And... Print a make_result applicable to each make_result type.
...
namespace Catch {
    ...
    struct ConsoleReporter : StreamingReporterBase {
        ...
        virtual bool assertionEnded( AssertionStats const& _assertionStats ) CATCH_OVERRIDE {
            ...
            // Drop out if make_result was successful and we're not printing those
